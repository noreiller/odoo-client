...
class OdooClient {
  ...
  _saveSession(session) {
    ...
    (0, _utils.warning)(values.password && typeof document !== 'undefined', `You provided a "password", use with caution in the browser since it can be exposed. Prefer use it only on the server.`);
